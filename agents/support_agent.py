...
class SupportManagerAgent:
    """TSPi Support Manager: baselines, app documentation, glossary."""
    ...
    def __init__(self, api_key: str) -> None:
        ...
        task_kwargs = {
            "description": "Produce a support governance package from the project artifacts.",
            "agent": self.agent,
            "expected_output": "A support governance package including documentation of the user's app, baseline artifacts, and glossary.",
        }
        if PYDANTIC_AVAILABLE and SupportGovernanceOutputModel is not None:
            task_kwargs["output_json"] = SupportGovernanceOutputModel
    ...
    def generate_support_package(
        ...
        """Generate support governance package from project artifacts."""
        if not self.api_key:
